...
This profile builds `api`, `web` and `worker` only. The `wdk-mcp` image builds
from [ai-wdk-mcp](https://github.com/VEuPathDB/ai-wdk-mcp) at the release its
compose build context names.
