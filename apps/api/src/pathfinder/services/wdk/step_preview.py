...
from pathfinder.integrations.veupathdb.factory import get_results_api, get_strategy_api
...
async def step_download_url(
    ...
    *,
    ...
    :raises AppError: WDK refused the request.
...
async def step_sample_records(
    ...
    *,
    ...
    :raises AppError: WDK refused the id-only read too.
    :raises OSError: The site was unreachable.
    """
