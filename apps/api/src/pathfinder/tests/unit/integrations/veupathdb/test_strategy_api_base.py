...
from pathfinder.domain.parameters.wdk_vocab import FAKE_ALL_SENTINEL, WDKVocabTerm
...
class TestACensusPatternIsRead:
    ...
    def test_present_and_absent_tokens(
        ...
        assert _read_census(pattern).states == states
...
class TestTheCodeCheck:
    ...
    def test_known_codes_pass(self) -> None:
        ...
        _validate_phyletic_codes(codes, _KNOWN)
