...
describe("ConversationSubtreeDialog branch links", () => {
  afterEach(cleanup);

  it("points every listed branch at its own site-scoped conversation route", () => {
    renderDialog();

    const hrefs = screen
      .getAllByTestId("subtree-dialog-item")
